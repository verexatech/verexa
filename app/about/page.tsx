      ...
      <section className="pt-36 pb-12 md:pt-48 md:pb-16 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-6xl font-normal leading-[1.05] bg-linear-to-b from-foreground from-20% to-muted-foreground sm:from-foreground sm:from-30% sm:to-muted-foreground to-100% bg-clip-text text-transparent mb-6 text-center"
          >
            Who We Are
          </motion.h1>
          <motion.p
      ...
      <section className="py-16 md:py-20 bg-background relative z-10">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <motion.h2
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="text-4xl sm:text-5xl lg:text-6xl font-normal leading-[1.1] bg-linear-to-b from-foreground from-20% to-muted-foreground sm:from-foreground sm:from-30% sm:to-muted-foreground to-100% bg-clip-text text-transparent mb-6 text-center"
          >
            Our Story
          </motion.h2>
          <motion.p
